...
TEST(WC232Q3_Problem1792Test, Basic) {
    vector<vector<int>> v1 {{1, 2}, {3, 5}, {2, 2}};
    EXPECT_NEAR(WC232Q3_Problem1792::maxAverageRatio(v1, 2), 0.78333, 1e-5);

    vector<vector<int>> v2 {{2, 4}, {3, 9}, {4, 5}, {2, 10}};
    EXPECT_NEAR(WC232Q3_Problem1792::maxAverageRatio(v2, 4), 0.53485, 1e-5);
}

TEST(WC232Q4_Problem1793Test, Basic) {
    vector<int> v1 {1, 4, 3, 7, 4, 5};
    EXPECT_EQ(WC232Q4_Problem1793::maximumScore(v1, 3), 15);

    vector<int> v2 {5, 5, 4, 5, 4, 1, 1, 1};
    EXPECT_EQ(WC232Q4_Problem1793::maximumScore(v2, 0), 20);
}
